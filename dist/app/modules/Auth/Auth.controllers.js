...
const createOTP = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
...
const getAccessToken = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    var _b;
    console.log(req.cookies);
    const result = yield Auth_services_1.AuthServices.getAccessToken((_b = req.cookies) === null || _b === void 0 ? void 0 : _b.refresh_token);
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
        success: true,
...
const resetPassword = (0, catchAsync_1.default)((req, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    const _c = yield Auth_services_1.AuthServices.resetPassword(req === null || req === void 0 ? void 0 : req.user, req.body), { refreshToken } = _c, result = __rest(_c, ["refreshToken"]);
    const maxAge = 60 * 24 * 60 * 60 * 1000;
    res.cookie("refresh_token", refreshToken, { maxAge, httpOnly: true });
    (0, sendResponse_1.default)(res, {
        statusCode: http_status_1.default.OK,
