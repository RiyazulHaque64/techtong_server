...
const uploadImages = (req) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!((_a = files === null || files === void 0 ? void 0 : files.images) === null || _a === void 0 ? void 0 : _a.length)) {
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "No images found");
    }
    const images = [];
...
const getImages = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (sortBy)
        (0, validateQueryFields_1.default)(Image_constant_1.imageFieldsValidationConfig, "sort_by", sortBy);
    if (sortOrder)
        (0, validateQueryFields_1.default)(Image_constant_1.imageFieldsValidationConfig, "sort_order", sortOrder);
    ...
    const andConditions = [
        { uploaded_from: client_1.UploadedFrom.ADMIN },
    ];
    if (searchTerm) {
        andConditions.push({
...
const deleteImages = (payload) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if ((error === null || error === void 0 ? void 0 : error.status) === 400 || (data === null || data === void 0 ? void 0 : data.length) === 0)
        throw new ApiError_1.default(http_status_1.default.BAD_REQUEST, "No valid image path found to delete");
