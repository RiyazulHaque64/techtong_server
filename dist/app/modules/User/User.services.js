...
const getUsers = (query) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (sortBy)
        (0, validateQueryFields_1.default)(User_constants_1.userFieldsValidationConfig, "sort_by", sortBy);
    if (sortOrder)
        (0, validateQueryFields_1.default)(User_constants_1.userFieldsValidationConfig, "sort_order", sortOrder);
    ...
    if (Object.keys(remainingQuery).length) {
        for (const [key, value] of Object.entries(remainingQuery)) {
            (0, validateQueryFields_1.default)(User_constants_1.userFieldsValidationConfig, key, value);
            andConditions.push({
...
const updateProfile = (user, payload, file) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (file) {
        ...
        if (!(data === null || data === void 0 ? void 0 : data.id)) {
            throw new ApiError_1.default(http_status_1.default.INTERNAL_SERVER_ERROR, "Failed to upload profile picture");
        }
        const image = {
            uploaded_from: client_1.UploadedFrom.USER,
        ...
        if (userInfo.profile_pic) {
            ...
            if (profilePic) {
                yield fileUploader_1.fileUploader.deleteToCloudinary([profilePic.bucket_id]);
...
const authorizeUserUpdate = (user, id) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (userData.role === client_1.UserRole.SUPER_ADMIN && user.role === client_1.UserRole.ADMIN) {
        throw new ApiError_1.default(http_status_1.default.UNAUTHORIZED, "Admins cannot modify Super Admin");
    }
});
